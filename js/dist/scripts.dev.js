...
function toggleDropdown(e) {
  ...
  var _m = document.querySelector(".dropdown-menu", _d);
...
document.querySelector(".dropdown").addEventListener("mouseover", toggleDropdown); // On click
...
var theModal = document.getElementById('staticBackdrop'); // Needs the if otherwise it will serve error on pages without the modal like the extra pages

if (theModal !== null) {
  var theModalGen = new bootstrap.Modal(theModal);
  var theModalCtaBtn = document.getElementById('modalCtaBtn');
